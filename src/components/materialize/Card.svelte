<script>
    import example250 from '../../node_modules/images/example-250x250.jpg';
    export let image = example250;
    export let title = "Card Title";
    export let links = [{placeholder:"This is a link",url:""}, {placeholder:"This is a link",url:""}];
